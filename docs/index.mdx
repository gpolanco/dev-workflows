...
<Columns cols={3}>
  <Card title="typescript-strict" href="/concepts/blocks">
    No any, explicit returns, union types over enums
  </Card>
  <Card title="react-conventions" href="/concepts/blocks">
    Hooks rules, component patterns, naming
  </Card>
  <Card title="nextjs-approuter" href="/concepts/blocks">
    App Router, RSC, server actions
  </Card>
  <Card title="tailwind" href="/concepts/blocks">
    Utility-first, no custom CSS, design tokens
  </Card>
  <Card title="testing-basics" href="/concepts/blocks">
    Test naming, coverage, mocks
  </Card>
  <Card title="supabase-rls" href="/concepts/blocks">
